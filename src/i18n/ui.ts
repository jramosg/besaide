...
export const ui = {
	es: {
		...
		'nav.routes': 'Rutas',
		'nav.leixagarate-aterpea': 'Leixagarate',
		'Leixargarate aterpetxea': 'Refugio de Leixagarate',
		...
		'material-rent.seo.title':
			'Alquiler de Material - Besaide Mendizale Elkartea',
		'material-rent.seo.description':
		...
		'contact.form.subject.membership': 'Ser socio',
		'contact.form.subject.services': 'Servicios',
		'contact.form.subject.activities': 'Actividades',
		'contact.form.subject.rental': 'Alquiler de material',
		'contact.form.subject.shelter': 'Refugio',
		...
		'event.registrationInfo':
			'Si estás interesado en participar en esta salida, ponte en contacto con nosotros. Escribe a besaide@besaide.eus.',
		...
		fieldQuality: 'El valor no parece válido',
		messageQuality: 'Escribe un mensaje un poco más claro',
	...
	eu: {
		...
		'contact.form.phone': 'Telefonoa',
		'contact.form.subject': 'Gaia',
		'contact.form.subject.placeholder': 'Aukeratu gai bat...',
		'contact.form.subject.membership': 'Bazkidetza',
		'contact.form.subject.services': 'Zerbitzuak',
		'contact.form.subject.activities': 'Ekintzak',
		'contact.form.subject.rental': 'Material alokairua',
		'contact.form.subject.shelter': 'Aterpetxea',
		'contact.form.subject.other': 'Beste bat',
		'contact.form.message': 'Mezua',
		'contact.form.message.placeholder': 'Idatzi hemen zure mezua...',
		...
		'event.registrationInfo':
			'Irteera honetan parte hartzea interesatzen bazaizu, jar zaitez gurekin harremanetan besaide@besaide.eus helbidera idatziz.',
		// Besaide page - Functioning section
		...
		fieldQuality: 'Balioak ez dirudi zuzena',
		messageQuality: 'Idatzi mezua argiago, mesedez',
